          ...
          <div ref={dropdownRef} className="relative">
            ...
            {dropdownOpen && (
              <div className="absolute bg-white border border-gray-100 rounded-xl shadow-md mt-2 w-44 z-20">
                <div
                  className="px-4 py-2 hover:bg-gray-50 cursor-pointer text-sm font-bold rounded-t-xl"
                  onClick={() => { setLogType("audit"); setDropdownOpen(false); }}
                >
                  Audit Logs
                </div>
                <div
                  className="px-4 py-2 hover:bg-gray-50 cursor-pointer text-sm font-bold rounded-b-xl"
                  onClick={() => { setLogType("variance"); setDropdownOpen(false); }}
                >
                  Variance Logs
                </div>
              </div>
              ...
              <table className="w-full text-left">
                ...
                <tbody className="text-[13px] font-bold text-gray-700">
                  {currentLogs.length > 0 ? currentLogs.map((log, i) => (
                    <tr key={i} className="group border-b border-gray-50 last:border-none hover:bg-[#FBFBFB] transition-colors">
                      <td className="px-8 py-5">
                        <span className="text-xs font-black text-gray-400 tracking-wider">WO-{log.work_order_id || 'N/A'}</span>
                      </td>
                      <td className="py-5">
                        <div>
                      ...
                      <td className="py-5 text-center">
                        <span className="text-sm font-black text-gray-500">{log.expected_qty ?? 'N/A'}</span>
                      </td>
                      <td className="py-5 text-center">
                        <span className="text-sm font-black text-gray-800">{log.actual_qty ?? 'N/A'}</span>
                      </td>
                    ...
                    <tr>
                      <td colSpan="7" className="py-20 text-center">
                        <div className="flex flex-col items-center gap-2 opacity-20">
                          <HiOutlineClipboardList size={48} />
                          <p className="text-xs font-black uppercase tracking-widest">No variance records yet</p>
                          <p className="text-[10px] text-gray-400 normal-case font-normal">Complete a work order with actual materials to see records here</p>
                        </div>
                      </td>
                    </tr>
                  )}
