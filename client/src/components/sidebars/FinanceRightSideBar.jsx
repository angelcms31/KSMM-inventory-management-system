    ...
    <div className="w-[280px] h-screen bg-[#262221] text-white flex flex-col sticky top-0 right-0 font-sans border-l border-white/5">
      <div className="p-6 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 rounded-lg bg-gray-700 overflow-hidden border border-white/10 shrink-0">
            <img 
          ...
          <div className="min-w-0">
            <h4 className="text-[14px] font-bold leading-none truncate">{userName}</h4>
            <p className="text-[11px] text-gray-500 mt-1 uppercase tracking-widest">{userRole}</p>
          </div>
        </div>
        <div className="relative cursor-pointer group p-1.5 rounded-full hover:bg-white/5 transition-all active:scale-90">
          <HiOutlineBell size={22} className="text-gray-400 group-hover:text-white" />
      ...
      <div className="px-6 mb-4">
        <div className="bg-[#1e1b1a] rounded-xl p-4 border border-white/5">
          ...
          <button 
            onClick={(e) => { e.stopPropagation(); navigate('/finance/logs'); }} 
      ...
      <div className="px-6 flex-grow pb-6 overflow-hidden">
        <div className="bg-[#1e1b1a] h-full rounded-xl p-4 border border-white/5 flex flex-col">
          ...
          <div className="text-gray-600 text-xs italic text-center mt-10">No new messages</div>
        </div>
      </div>
    </div>
  );
